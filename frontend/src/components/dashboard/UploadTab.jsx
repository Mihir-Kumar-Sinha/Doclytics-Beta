        ...
        {uploadState === 'complete' && result && (
          <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="py-8 flex flex-col items-center">
            ...
            <div className="flex space-x-4">
              ...
              <a href="/dashboard/analytics" className="px-6 py-2 bg-blue-600 hover:bg-blue-500 text-white rounded-lg transition font-medium shadow-lg shadow-blue-600/20">
                View Analysis
              </a>
            </div>
          </motion.div>
